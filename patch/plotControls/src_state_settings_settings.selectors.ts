...
export const selectPlotYMax = (state: State): number => state.settings.plotYMax

export const selectPlotXMax = (state: State): number => state.settings.plotXMax

export const selectPlotYMin = (state: State): number => state.settings.plotYMin

export const selectPlotXMin = (state: State): number => state.settings.plotXMin
