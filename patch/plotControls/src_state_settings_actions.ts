...
export const setPlotYMax = action<number>('SET_PLOT_Y_MAX')
export const setPlotXMax = action<number>('SET_PLOT_X_MAX')
export const setPlotYMin = action<number>('SET_PLOT_Y_MIN')
export const setPlotXMin = action<number>('SET_PLOT_X_MIN')
