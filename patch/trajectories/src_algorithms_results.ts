...
function operationTP(
  ...
  return {
    ...
    current: {
      ...
      infected: operator(x.current.infected, y.current.infected),
      dailyNewInfected: operator(x.current.dailyNewInfected, y.current.dailyNewInfected),
      weeklyNewInfected: operator(x.current.weeklyNewInfected, y.current.weeklyNewInfected),
    },
    cumulative: {
