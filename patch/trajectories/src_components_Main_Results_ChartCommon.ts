...
export const DATA_POINTS = {
  ...
  Infected: 'infected',
  DailyNewInfected: 'dailyNewInfected',
  WeeklyNewInfected: 'weeklyNewInfected',
...
export const colors = {
  ...
  [DATA_POINTS.Infected]: '#A54974',
  [DATA_POINTS.DailyNewInfected]: '#9F55E8',
...
export const linesToPlot: LineProps[] = [
  ...
  { 
    key: DATA_POINTS.WeeklyNewInfected, 
    color: colors.weeklyNewInfected, 
    name: "Weekly new infected / 5.6", 
    legendType: 'line' 
  },
...
export const areasToPlot: LineProps[] = [
  ...
  {
    key: `${DATA_POINTS.Infected}Area`,
    color: colors.infected,
    name: 'Infected (model) uncertainty',
    legendType: 'none',
  }, 
  {
    key: `${DATA_POINTS.DailyNewInfected}Area`,
    color: colors.dailyNewInfected,
    name: 'Daily new infected (model) uncertainty',
    legendType: 'none',
  }, 
  {
    key: `${DATA_POINTS.WeeklyNewInfected}Area`,
    color: colors.weeklyNewInfected,
    name: 'Weekly new infected (model) uncertainty',
    legendType: 'none',
  }, 
]
