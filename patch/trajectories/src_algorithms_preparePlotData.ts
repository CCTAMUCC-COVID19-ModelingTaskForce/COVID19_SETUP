  ...
  return middle.map((x, day) => {
    return {
      ...
      lines: {
        ...
        infected: verifyPositive(x.current.infected.total),
        dailyNewInfected: verifyPositive(x.current.dailyNewInfected.total),
        weeklyNewInfected: verifyPositive(x.current.weeklyNewInfected.total),
      },
      // Error bars
      areas: {
        ...
        infected: verifyTuple(
          [
            verifyPositive(lower[day].current.infected.total),
            verifyPositive(upper[day].current.infected.total),
          ],
          x.current.infected.total,
        ),
        dailyNewInfected: verifyTuple(
          [
            verifyPositive(lower[day].current.dailyNewInfected.total),
            verifyPositive(upper[day].current.dailyNewInfected.total),
          ],
          x.current.dailyNewInfected.total,
        ),
        weeklyNewInfected: verifyTuple(
          [
            verifyPositive(lower[day].current.weeklyNewInfected.total),
            verifyPositive(upper[day].current.weeklyNewInfected.total),
          ],
          x.current.weeklyNewInfected.total,
        ),
      },
    }
  })
