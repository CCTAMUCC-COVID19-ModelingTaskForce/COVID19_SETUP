...
import {MitigationTransmissionButtons} from './MitigationControlButtons'
...
// import { 
// 	ReactiveBase,RangeSlider,  CategorySearch, SingleRange, ResultCard, ReactiveList 
// } from '@appbaseio/reactivesearch';

import { SliderComponent, TooltipDataModel,SliderTickRenderedEventArgs,TicksDataModel } from "@syncfusion/ej2-react-inputs";
import { MitigationTransmissionRange } from './MitigationTransmissionRange'
    ...
    <div className="mitigation-item">
      <div className="mitigation-item-container">
        ...
        <div className="mitigation-item-datum mitigation-item-efficiency-wrapper">
          ...
          <div>
            <MitigationTransmissionRange
              identifier={`mitigation.mitigationIntervals[${index}].transmissionReduction`}
              value={interval.transmissionReduction}
            />
          </div>

          <div>
          <MitigationTransmissionButtons
              identifier={`mitigation.mitigationIntervals[${index}].transmissionReduction`}
              value={interval.transmissionReduction}
            />
          </div>
