...
# ------------------------------------------------------------------------
# Globals
counties = ['hale', 'king', 'cochran', 'crosby', 'bailey', 'lamb', 'motley', 'scurry', 'garza', 'lynn', 'dickens', 'borden', 'cottle', 'gaines', 'floyd', 'dawson', 'terry', 'castro', 'lubbock', 'yoakum', 'hockley', 'kent', ]
parserName = 'TSA-B'
