...
# ------------------------------------------------------------------------
# Globals
counties = ['guadalupe', 'maverick', 'bandera', 'edwards', 'la_salle', 'dimmit', 'real', 'kinney', 'gillespie', 'bexar', 'kendall', 'val_verde', 'wilson', 'uvalde', 'karnes', 'comal', 'kerr', 'medina', 'frio', 'zavala', 'gonzales', 'atascosa', ]
parserName = 'TSA-P'
