...
# ------------------------------------------------------------------------
# Globals
counties = ['marion', 'rains', 'henderson', 'anderson', 'upshur', 'cherokee', 'freestone', 'smith', 'houston', 'wood', 'gregg', 'franklin', 'harrison', 'van_zandt', 'trinity', 'shelby', 'camp', 'panola', 'rusk', ]
parserName = 'TSA-G'
